...
pub trait ContextMenu {
	...
	#[cfg(target_os = "windows")]
	unsafe fn show_context_menu_for_hwnd(&self, hwnd: isize, position: Option<dpi::Position>) -> bool;
	...
	fn show_context_menu_for_gtk_window(&self, w: &gtk::Window, position: Option<dpi::Position>) -> bool;
