...
impl Menu {
	...
	pub fn with_id_and_items<I: Into<MenuId>>(id: I, items: &[&dyn IsMenuItem]) -> crate::Result<Self> {
...
impl ContextMenu for Menu {
	...
	#[cfg(all(target_os = "linux", feature = "gtk"))]
	fn show_context_menu_for_gtk_window(&self, window: &gtk::Window, position: Option<Position>) -> bool {
	...
	#[cfg(target_os = "macos")]
	unsafe fn show_context_menu_for_nsview(&self, view: *const std::ffi::c_void, position: Option<Position>) -> bool {
